...
setwd("C:/Users/User/AMH Dropbox/Emine Guven/hsc-jbcb/processing")
...
#gds<-getGEO("GDS3942")
#gds <- getGEO(filename=system.file("extdata/GDS3942.soft.gz",package="GEOquery"))
#gset=readRDS("GSE32719.rds", refhook = NULL)
...
write.table(sig.genes, "__sig.genes.symbols.tsv", sep="\t", quote=F, row.names=F, col.names=F  )
