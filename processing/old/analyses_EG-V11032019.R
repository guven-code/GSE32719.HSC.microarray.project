...
pdf(paste("C:/Users/lenovo/Dropbox/analiz/grafikler/", "boxplot.pdf",sep=''),width=8,height=5)
...
heatmap(exprs(gsetSel))
#pdf(paste("C:/Users/lenovo/Dropbox/analiz/grafikler/" ,"heatmap.pdf",sep=''),width=8,height=5)
heatmap(exprs(gsetSel), col=topo.colors(100))
#dev.off()
